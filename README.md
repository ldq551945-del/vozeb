...
- 网页画布助手：使用管理员配置的文本模型在网页内处理画布任务，支持确认工具操作并保留对话记录。
- 站点设置：管理员可配置邮箱、联系反馈、友情链接和创作服务，普通用户端只显示 DQ 品牌和必要的服务说明。
...
邮箱联系：默认使用 QQ 邮箱格式，支持 mailto: 邮箱链接
Telegram：默认关闭，可填写频道或联系人链接
X：默认关闭，可填写反馈或主页链接
联系反馈：默认关闭，可填写微信二维码或联系页链接，启用后固定显示图标和文字
```
