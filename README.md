...
VOZEB 当前版本为 `v0.7.5`，这是基于原创开源画布项目继续开发的二开版本。感谢原创作者 basketikun 对无限画布、AI 创作工作流、Canvas Agent 和 Codex 插件能力的开源贡献。
...
- AI 图片创作：支持文生图、图生图、参考图编辑、图片反推提示词、图片切图、局部蒙版修改和图片放大；图片工作台支持按生成记录保留结果、同记录追加生成、失败重试、任务轮询续取、结果勾选删除、记录标题重命名、图片恢复 fallback 和每用户并发生成上限。
