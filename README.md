<p align="center">
  <img src="web/public/logo.svg?v=0.7.8-white" width="108" alt="VOZEB logo">
</p>
...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-v0.7.8-2563eb?style=flat-square" alt="Version"></a>
...
VOZEB 当前版本为 `v0.7.8`，这是基于原创开源画布项目继续开发的二开版本。感谢原创作者 basketikun 对无限画布、AI 创作工作流、Canvas Agent 和 Codex 插件能力的开源贡献。

版本更新记录请查看 [GitHub Releases](https://github.com/csyqlz/vozeb/releases)。

## 最新更新

`v0.7.8` 继续修复管理员后台生成日志筛选体验：日期范围移到桌面端第一行右侧，手机端筛选和批量操作按两列/整行稳定排列，日期输入显示完整年份并进一步收紧中间空白位。画布文本生成与图片反推提示词改为服务端任务轮询，刷新页面后可继续取回结果，失败重试也会保留原始组合提示词里的图片引用。发布说明会补齐近期版本更新摘要，避免 GitHub Releases 出现更新日志断层。
