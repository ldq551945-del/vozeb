...
export const CanvasNode = React.memo(function CanvasNode({
    ...
    return (
        ...
        >
            ...
            {showPanel && renderPanel ? <div className="absolute left-1/2 top-full z-[70] w-[min(500px,calc(100vw-24px))] max-w-[calc(100vw-24px)] -translate-x-1/2 pt-4">{renderPanel(data)}</div> : null}
        </div>
    );
});
